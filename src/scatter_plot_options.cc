  ...
  y_(params, node + "y.")
{
  ...
  marker_colors_ = *params.get<vector<Int_t>, Int_t>(node+"marker.colors");
  marker_sizes_ = *params.get<vector<Float_t>, Float_t>(node+"marker.sizes");
  marker_styles_ = *params.get<vector<Int_t>, Int_t>(node+"marker.styles");
